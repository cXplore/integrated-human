          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-2 space-y-6">
                ...
                {/* Continue Reading - shows in-progress articles */}
                <ContinueReading />
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                  <a
                    href="/courses"
                    className="group bg-[var(--card-bg)] border border-[var(--border-color)] p-4 hover:border-zinc-600 transition-colors"
                  >
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-white font-medium text-sm">Practices</span>
                    </div>
                    <p className="text-gray-500 text-xs">Breathwork & more</p>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <p className="text-gray-500 text-xs">Reflect & write</p>
                  </a>
                  <a
                    href="/profile/dreams"
                    className="group bg-[var(--card-bg)] border border-[var(--border-color)] p-4 hover:border-zinc-600 transition-colors"
                  >
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-white font-medium text-sm">Dreams</span>
                    </div>
                    <p className="text-gray-500 text-xs">Explore symbols</p>
                  </a>
                  <a
                    href="/reading-list"
                    className="group bg-[var(--card-bg)] border border-[var(--border-color)] p-4 hover:border-zinc-600 transition-colors"
                  >
                    ...
                    <p className="text-gray-500 text-xs">Reading list</p>
                  </a>
                </div>
                ...
                <div className="bg-[var(--card-bg)] border border-[var(--border-color)] p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <a
                      ...
                      className="flex items-center justify-between py-3 text-gray-400 hover:text-white transition-colors group"
                    >
