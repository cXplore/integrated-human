...
export default function SoulPage() {
  ...
  const articles = getArticlesByCategory('Soul');
  const availableTags = getTagsByCategory('Soul');
      ...
      <main className="min-h-screen bg-zinc-950">
        <section className="py-20 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            {soulFoundations.length > 0 && (
              <div className="mb-16">
                ...
                <p className="text-gray-400 mb-6 leading-relaxed">
                  Practices and perspectives for going deeper. Meditation, consciousness, and the tools for inner exploration.
                </p>
                <div className="border border-zinc-800 divide-y divide-zinc-800">
                  {soulFoundations.map((post, index) => (
                    <Link
                      key={post.slug}
            ...
            {articles.length === 0 && soulFoundations.length > 0 && (
